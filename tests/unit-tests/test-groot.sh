...
GROOT_BASE="$(readlink -f $(dirname $(readlink -f "$0"))/../..)"
...
function setUp(){
    ...
    source $GROOT_BASE/bin/groot -h &> /dev/null
    set +e
...
function test_groot_with_chroot_teardown(){
    ...
    assertEquals "$(echo -e "umount(--force --recursive /home/mychroot/proc/fs1)
umount(--force --recursive /home/mychroot/proc)
umount(--force --recursive /home/mychroot/dev/shm)
umount(--force --recursive /home/mychroot/dev)
umount(--force --recursive /home/mychroot)")" "$(cat $STDOUTF)"
}

function test_groot_with_chroot_teardown_umount_failure(){
    function umount() {
        echo "umount($@)"
        [[ "$@" == "--force --recursive /home/mychroot/dev/shm" ]] && return 128
        return 0
    }
    UMOUNT=umount
    echo -e "1 /home/mychroot/dev\n1 /home/mychroot/proc/fs1\n1 /home/mychroot\n1 /home/mychroot-no/dev\n1 /home/mychroot/dev/shm\n1 /home/mychroot/proc\n" > ./mounts
